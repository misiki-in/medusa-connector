...
export type Blog = {
	...
	slug: string // Handle/slug for the blog URL
	title: string // Title of the blog
	description: string // Description or body HTML of the blog
	image: string | null // Featured image URL
	publishedAt: string // Timestamp when the blog was published
	updatedAt: string // Timestamp when the blog was last updated
	status: string // Status of the blog (e.g., active, draft)
	user?: string // Optional user ID of the author
